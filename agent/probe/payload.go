...
type PayloadData struct {
	...
	// Wan: uplink state (proto, public IP, gateway, DNS and the socket it
	// leaves through). The server probed this over SSH and only on the
	// gateway, a path that does not exist on an agent_only router: without
